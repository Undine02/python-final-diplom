...
from shop.serializers import CategorySerializer, ShopSerializer, UserSerializer, ProductInfoSerializer, OrderSerializer, OrderItemSerializer
            ...
            try:
                ...
                for order_item in items_dict:
                    if type(order_item['product_info_id']) == int and type(order_item['quantity']) == int \
                        ...
                        if product_info:
                            current_item = OrderItem.objects.filter(order_id=basket.id,
                                                                    product_info_id=product_info[0].id)
                            if not current_item:
